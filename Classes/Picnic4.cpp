...
USING_NS_CC;
CCScene* Picnic4::scene()
{
    CCScene *scene = CCScene::create();
    Picnic4 *layer = Picnic4::create();
...
void Picnic4::playEffect1()
{
    SimpleAudioEngine::sharedEngine()->playBackgroundMusic("Picnic_04_a.mp3");
}

void Picnic4::playEffect2(){
}


void Picnic4::SetvisibilityForTextBackground1()
{
    labelBackgroundSprite->setVisible(true);
}

void Picnic4::SetvisibilityForTextBackground2()
{
    labelBackgroundSpriteForlabel2->setVisible(true);
}


void Picnic4::createMenu()
{
    btnBack = newButton("back", getX(100), getY(600), this, menu_selector(Picnic4::onBack), false, RATIO_X);
    btnNext = newButton("next", G_SWIDTH - getX(100), getY(600), this, menu_selector(Picnic4::onNext), false, RATIO_X);
    
    CCMenuItemImage *btnHome = newButton("home", getX(100), getY(70), this, menu_selector(Picnic4::onHome), false, RATIO_X);
...
void Picnic4::onBack(){
    ...
    CCDirector::sharedDirector()->replaceScene(CCTransitionPageTurn::create(1.0f, Picnic3::scene(), true));
}
...
void Picnic4::onNext(){
    ...
    SimpleAudioEngine::sharedEngine()->playEffect("page_flip.wav");
    CCDirector::sharedDirector()->replaceScene(CCTransitionPageTurn::create(1.0f, Picnic5::scene(), false));
}

void Picnic4::registerWithTouchDispatcher()
{
    CCDirector::sharedDirector()->getTouchDispatcher()->addTargetedDelegate(this, 0, true);
}

bool Picnic4::ccTouchBegan(cocos2d::CCTouch *touch, cocos2d::CCEvent *event)
{
